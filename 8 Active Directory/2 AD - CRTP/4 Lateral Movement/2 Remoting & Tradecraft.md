...
❯ $Sess = New-PSSession -ComputerName server1 
	❯ Invoke-Command -Session $Sess -ScriptBlock {$env:computername;$env:username}
...
❯ winrs -r:server1 set computername 
