...
Notas:
	- Al momento de abrir una terminal linux en Windows con wsl2, esta será la ruta '/mnt/c/Users/user'
...
Notas:
	- Ejemplo de GPO Name: {0BF8D01C-1F62-4BDC-958C-57140B67D147} la cual se obtiene del comando anterior 'Get-DomainGPO' en la parte de 'name' del grupo 'DevOps'
