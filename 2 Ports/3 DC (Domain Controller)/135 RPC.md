...
# Copiar el resultado del comando anterior y hacer el filtro para obtener solo los usuarios 
❯ cat rid_cycling_output.txt | awk -F'\\\\' '/SidTypeUser/ {split($2,a," "); print a[1]}' > users.txt
```
